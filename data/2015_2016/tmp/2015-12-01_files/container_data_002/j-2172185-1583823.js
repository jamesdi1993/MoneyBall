...
var ft2172185 = {
	params:window.ftParams_2172185||"",
	confID:window.ftConfID_2172185||"0",
	guid:window.ftGUID_2172185||"99999999999",
	ftId:'',
    ftImpId: window.ftImp2172185 && window.ftImp2172185.impID || '',
	pID:2172185,
	creativeID:"1583823",
	campaignID: "68996",
	exttrack:[],
	...
	width:"728",
	height:"90",
	altimg:"http://cdn.flashtalking.com/xre/217/2172185/1583823/image/1583823.gif",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/8/68996;2172185;202;pixel;DBM;DBM223988DTHalloweenGMAAHA728x90/?",
    stump: "http://servedby.flashtalking.com",
	altimghref:"http://servedby.flashtalking.com/click/8/68996;2172185;1583823;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.walmart.com/cp/halloween/615760?veh=bv_dis&IID=223988",
	switchArray:["altimg", "altimghref", "cdnSrc", "cdnGUID", "iDeviceImp", "statBaseURL", "viewableImpressionURL", "cdnSrc", "iDeviceImp"],
	statBaseURL:"http://stat8.flashtalking.com/reportV3/ft.stat?72492813-2172185;1583823;",
	divID:"ftdiv2172185",
	altimgID:"ftalt2172185",
    imgID: "ftImg2172185",
    frameID:"ftframe2172185",
	alttext:"Click here",
	altimgtarget:"_blank",
	altimgborder:"0",
	centreAd:true,
	...
	iDeviceImp:"http://servedby.flashtalking.com/imp/8/68996;2172185;207;guid;DBM;DBM223988DTHalloweenGMAAHA728x90/?ft_guid=",
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m2172185[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	adDisplayed: false,
    w: window,
    qsVars:[
        ["ftguid","ftGUID_2172185"],
        ["ftcfid","ftConfID_2172185"],
        ["ftcustom","ftCustom_2172185"],
        ["fttime","ftTimestamp_2172185"],
        ["ftsection","ftSection_2172185"],
        ["ft_id", "ftID"],
        ['ftimpid', 'ftImp2172185', 'impID']
    ],
	api: {
		fallbackAPI: {
            ft: null,
	...
	scriptLocation: document.getElementById('ftscript_m2172185'),
	$:function(el){
		var o=this,
		x = el||o.divID,
		p={o:o};
	...
	outputDiv:function(frame){
		...
		div += o[content]();
		div += '</div>';
		if(window.ftImp2172185 && window.ftImp2172185.jsAppend) {
